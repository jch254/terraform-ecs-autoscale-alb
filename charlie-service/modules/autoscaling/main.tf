...
resource "aws_cloudwatch_metric_alarm" "charlie_service_cpu_high" {
...
resource "aws_cloudwatch_metric_alarm" "charlie_service_cpu_low" {
...
resource "aws_cloudwatch_metric_alarm" "charlie_service_memory_high" {
...
resource "aws_cloudwatch_metric_alarm" "charlie_service_memory_low" {
